<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MultiviewController.aspx.cs" Inherits="FileUploadController.MultiviewController" %>
            ...
            <asp:MultiView ID="MultiView1" runat="server">
                      ...
                      <table style="border: 1px solid black">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right">
                                <asp:Button ID="btnGoStep3" runat="server" Text="Step 3 >>" OnClick="btnGoStep3_Click" />
                            </td>
                        </tr>
                    </table>
                ...
                <asp:View ID="ViewSummary" runat="server">
                     <table style="border: 1px solid black">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="Button1" runat="server" Text="<< Step 2" OnClick="Button1_Click" /></td>
                            <td style="text-align: right">
